...
from .forms import EditCategoryForm,WriterNewsForm,AddBannerForm,EditBannerForm,EditNewsForm
import os,qiniu
...
class writerNewsView(View):
    def get(self,request):
        ...
        return render(request,'cms/writerNews.html',context=context)
    def post(self,request):
        form = WriterNewsForm(request.POST)
        if form.is_valid():
